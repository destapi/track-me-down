...
export default function TripChargeUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAmount_charged(cleanValues.amount_charged);
    setTip_applied(cleanValues.tip_applied);
    setPassenger(cleanValues.passenger);
    setTrip_summary(cleanValues.trip_summary);
    setErrors({});
  };
