...
import { createDriverPool } from "../graphql/mutations";
const client = generateClient();
export default function DriverPoolCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPoolTitle(initialValues.poolTitle);
    setErrors({});
  };
  const validations = {
    poolTitle: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDriverPool.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DriverPoolCreateForm")}
      {...rest}
    >
      <TextField
        label="Pool title"
