...
export default function VehicleUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = vehicleRecord
      ...
      : initialValues;
    setVin(cleanValues.vin);
    setMake(cleanValues.make);
    setModel(cleanValues.model);
    setYear(cleanValues.year);
    setRegistrationNum(cleanValues.registrationNum);
    setRegistrationState(cleanValues.registrationState);
    setRegistrationCopy(cleanValues.registrationCopy);
    setInsuranceProof(cleanValues.insuranceProof);
    setErrors({});
  };
