...
import { createVehicleFleet } from "../graphql/mutations";
const client = generateClient();
export default function VehicleFleetCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createVehicleFleet.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "VehicleFleetCreateForm")}
      {...rest}
    >
      <TextField
        label="Fleet title"
